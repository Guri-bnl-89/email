...
<section>
    ...
    <div class="row">
      <div class="col-12 col-lg-4 mb-6 mb-lg-0">
        ...
        <div class="card border-0 bg-transparent">
          <div class="position-absolute bg-white shadow-primary text-center p-2 rounded ms-3 mt-3">15
            <br>July</div>
          <img class="card-img-top shadow rounded" src="{{ asset('assets/front/images/blog/01.png') }}" alt="Image">
      ...
      <div class="col-12 col-lg-4 mb-6 mb-lg-0">
        ...
        <div class="card border-0 bg-transparent">
          <div class="position-absolute bg-white shadow-primary text-center p-2 rounded ms-3 mt-3">15
            <br>July</div>
          <img class="card-img-top shadow rounded" src="{{ asset('assets/front/images/blog/02.png') }}" alt="Image">
      ...
      <div class="col-12 col-lg-4">
        ...
        <div class="card border-0 bg-transparent">
          <div class="position-absolute bg-white shadow-primary text-center p-2 rounded ms-3 mt-3">15
            <br>July</div>
          <img class="card-img-top shadow rounded" src="{{ asset('assets/front/images/blog/03.png') }}" alt="Image">
  ...
  <div class="col-12">
    <nav aria-label="...">
      <ul class="pagination">
        <li class="page-item me-auto"> <a class="page-link" href="#">Previous</a>
        </li>
        ...
        <li class="page-item ms-auto"> <a class="page-link" href="#">Next</a>
        </li>
      </ul>
    </nav>
  </div>
